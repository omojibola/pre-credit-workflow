          ...
          {msg.isStreaming && msg.content && (
            <span
              style={{
                ...
                animation: 'assistantCursor .7s ease-in-out infinite',
              }}
            />
          )}
        </div>
        ...
        >
          ...
          >
            <div
              style={{
                ...
                animation: isLoading
                  ? 'none'
                  : 'assistantDot 2s ease-in-out infinite',
              }}
            />
            <span
              style={{
          ...
          <button
            ...
            onMouseLeave={(e) => {
              ...
              e.currentTarget.style.color = '#2a3040';
            }}
            style={{
              background: 'transparent',
              border: '1px solid #1a1a24',
          ...
          >
            ...
            <span
              style={{
                ...
                fontSize: 10,
                color:
                  ctx.sessionDV01 > 200_000
                    ? '#f87171'
                    : ctx.sessionDV01 > 150_000
                      ? '#fcd34d'
                      : '#4ade80',
              }}
            >
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontSize: 10,
                  color:
                    ctx.rfqState.status === 'QUOTED'
                      ? '#4ade80'
                      : ctx.rfqState.status === 'PENDING'
                        ? '#fbbf24'
                        : '#f97316',
                }}
              >
        ...
        >
          {messages.length === 0 ? (
            <div style={{ padding: '32px 20px', textAlign: 'center' }}>
              ...
              >
                Your AI market assistant has real-time access to live spreads,
                your session trades, open RFQs, and dealer performance.
              </div>
              <div
                style={{
                  marginTop: 12,
              ...
              style={{
                ...
                background:
                  isLoading || !input.trim()
                    ? '#111318'
                    : 'linear-gradient(135deg,#0066cc,#0052aa)',
              ...
              {isLoading ? (
                <span
                  style={{
                    ...
                    borderTopColor: '#e2b96b',
                    borderRadius: '50%',
                    display: 'block',
                    animation: 'assistantDot 0.8s linear infinite',
                  }}
                />
              ) : (
                '↑'
